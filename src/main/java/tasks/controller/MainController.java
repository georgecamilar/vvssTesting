...
public class MainController {
    ...
    @FXML
    public void showTaskNewDialog(ActionEvent actionEvent){
    ...
    public void showTaskEditDialog(ActionEvent actionEvent){
        Object source = actionEvent.getSource();
        NewEditController.setClickedButton((Button) source);
    ...
    public void showFilteredTasks(){
        LocalDate dataStart=datePickerFrom.getValue();
        LocalDate dataEnd=datePickerTo.getValue();
        String oraStart=fieldTimeFrom.getText();
        if(oraStart.equals("")){
            oraStart="00:00";
        }
        String oraEnd=fieldTimeTo.getText();
        if(oraEnd.equals("")){
            oraEnd="23:59";
        }
        ...
        if(dataStart==null || dataEnd==null){
            ...
            Date start = getDateFromFilterField(dataStart, oraStart);
            Date end = getDateFromFilterField(dataEnd, oraEnd);
